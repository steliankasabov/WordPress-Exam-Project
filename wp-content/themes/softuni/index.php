                    ...
                    <div class="grid" id="portfolio-grid">
                        ...
                        <div class="grid-item element-item p_one">
                            <a href="single-portfolio.html">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/portfolio_item_01.jpg" alt="">
                        ...
                        <div class="grid-item element-item p_one_half">
                            <a href="single-portfolio2.html">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/portfolio_item_02.jpg" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="images/icon_post.svg" alt="">
                        ...
                        <div class="grid-item element-item p_one_half">
                            <a data-rel="prettyPhoto[gallery1]" href="demo-images/portfolio_item_08.jpg">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/portfolio_item_08.jpg" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="images/icon_post.svg" alt="">
                        ...
                        <div class="grid-item element-item p_one">
                            <a data-rel="prettyPhoto[gallery1]" href="demo-images/portfolio_item_05.jpg">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/portfolio_item_05.jpg" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="images/icon_post.svg" alt="">
                        ...
                        <div class="image-slider-wrapper relative img aboutImage">
                            ...
                            <div class="caroufredsel_wrapper">
                                <ul id="aboutImage" class="image-slider slides">
                                    <li><img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/about_img_04.jpg" alt=""></li>
                                    <li><img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/about_img_05.jpg" alt=""></li>
                                    <li><img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/about_img_06.jpg" alt=""></li>
                                </ul>
                            </div>
                            <div class="clear"></div>
                        </div>
                                ...
                                <ul id="team1" class="image-slider slides">
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/about_img_01.jpg" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/about_img_02.jpg" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/about_img_03.jpg" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                </ul>
                ...
                <div class="fwslider1 fw-image-slider-holder list_carousel relative">
                    <div class="caroufredsel_wrapper">
                        <ul id="fwslider1" class="fw-image-slider">
                            <li class="fw-slide">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/icon_editing.png" alt="">
                                <p class="fw-slide-text">Video Editing</p>
                            </li>
                            <li class="fw-slide">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/icon_clear.png" alt="">
                                <p class="fw-slide-text">Premium Cleer</p>
                            </li>
                            <li class="fw-slide">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/icon_display.png" alt="">
                                <p class="fw-slide-text">For All Displays</p>
                            </li>
                            <li class="fw-slide">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/icon_time.png" alt="">
                                <p class="fw-slide-text">Right On Time</p>
                            </li>
                            <li class="fw-slide">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/icon_ideas.png" alt="">
                                <p class="fw-slide-text">Innovative Ideas</p>
                            </li>
                            <li class="fw-slide">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/icon_sound.png" alt="">
                                <p class="fw-slide-text">Perfect Sound</p>
                            </li>
                            <li class="fw-slide">
                                <img src="http://localhost/softuni/wp-content/themes/softuni/demo-images/icon_solution.png" alt="">
